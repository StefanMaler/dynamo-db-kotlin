...
class DynamoDbAwsJavaSdkCoroutinesIT {
    ...
    suspend fun createTable(ddb: DynamoDbAsyncClient, tableName: String, key: String): String {
        ...
        val waitUntilTableExists: CompletableFuture<WaiterResponse<DescribeTableResponse>> = waiter.waitUntilTableExists(describeTableRequest)
        waitUntilTableExists.get().matched().response().ifPresent(System.out::println)

        val tableName: String = createTableResponse.await().tableDescription().tableName()
        return tableName
    }
    ...
    // https://docs.aws.amazon.com/sdk-for-java/latest/developer-guide/examples-dynamodb-tables.html
    suspend fun getItem(client: DynamoDbAsyncClient, tableName: String, key: String, keyVal: String): Map<String, String> {
        ...
        try {
            ...
            val item: Map<String, AttributeValue> = client.getItem(request).await().item()
